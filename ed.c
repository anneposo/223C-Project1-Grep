...
#include <signal.h>		//********************* compiles without this header existing in project folder, is this needed?
#include <setjmp.h>		//********************* compiles without this header existing in project folder, is this needed?
